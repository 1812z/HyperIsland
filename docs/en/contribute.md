...
1. Create an Issue on [GitHub Issues](https://github.com/1812z/HyperIsland/issues)
2. Provide detailed reproduction steps or screenshots
3. For bugs, please upload LSPosed logs

::: tip When Submitting Bug Reports
Please include:
...
See [Build Guide](/en/build) for details.
...
This project is open source under [MIT License](https://github.com/1812z/HyperIsland/blob/main/LICENSE).
