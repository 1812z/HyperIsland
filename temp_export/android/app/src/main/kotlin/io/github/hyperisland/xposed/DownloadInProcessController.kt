...
object InProcessController {
    ...
    private fun loadSettings() {
        resumeNotificationEnabled = SettingsBridge.getBoolean("pref_resume_notification", true)
        useHookAppIconEnabled     = SettingsBridge.getBoolean("pref_use_hook_app_icon", true)
    ...
    fun ensureRegistered(context: Context) {
        ...
        ConfigManager.init(appCtx)
        SettingsBridge.init(appCtx)
        loadSettings()
