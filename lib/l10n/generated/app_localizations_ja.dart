...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get islandSwipeActionsTitle => 'スワイプ操作';
  ...
  @override
  String get islandSwipeActionCancelNotification => '通知を消去';
  ...
  String get bluetoothIslandShowDeviceNameSubtitle =>
      '接続時は右側にデバイス名を先に表示し、その後に接続状態を表示します';

  @override
  String get bluetoothIslandDisplayDurationTitle => '表示時間';
  ...
  String get hideLockscreenFaceUnlockIconSubtitle =>
      '顔認証機能に影響を与えず、ロック画面の顔認証表示を非表示にします';
  ...
  String get hideBehaviorMasterSwitchSubtitle =>
      '有効にすると非表示動作のインターセプト機能が有効になります；オフにすると完全に無効になります';
